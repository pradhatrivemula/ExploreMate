...
namespace JSONWebAPI
{
    public interface IServiceAPI
    {
        ...
        string getplaceid();
        string addfinalroute(string id, string uid, string placeno, string name, string cont, string lat, string lng, string add, string dist, string isopen, string opentill, string rating, string review, string price, string time_frame, string date,string latlng);
